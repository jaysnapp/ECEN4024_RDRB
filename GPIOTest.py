...
GPIO.setup(19, GPIO.IN, pull_up_down=PUD_DOWN)
GPIO.setup(13, GPIO.IN, pull_up_down=PUD_DOWN)
GPIO.setup(6, GPIO.IN, pull_up_down=PUD_DOWN)
GPIO.setup(2, GPIO.IN, pull_up_down=PUD_DOWN)
GPIO.setup(3, GPIO.IN, pull_up_down=PUD_DOWN)
GPIO.setup(12, GPIO.IN, pull_up_down=PUD_DOWN)
GPIO.setup(14, GPIO.IN, pull_up_down=PUD_DOWN)
